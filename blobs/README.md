...
1. Include BinForge.h / blob at compile time
2. Inject data into blob using BinForge CLI tool(or GUI)
3. Flash firmware normally
4. Detect blob status at runtime using `BinForge.h` (see examples)
5. Interpret payload data in user code if blob has been altered
